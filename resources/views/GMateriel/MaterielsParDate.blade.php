...
<div class="max-w-6xl mx-auto p-8">
    @if($materiels->isEmpty())
        <p class="text-center text-gray-600">Aucun matériel trouvé pour cette date.</p>
    @else
        <h1 class="text-center text-xl font-semibold mb-4">Liste des matériels correspondant à la date : {{ $date }}</h1>
